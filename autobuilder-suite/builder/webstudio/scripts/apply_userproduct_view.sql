-- Recreate UserProduct view and grant SELECT to public roles
...
-- Grants (adjust role names if you use different PostgREST roles)
...
-- Also ensure DashboardProject (used by the dashboard) exists and has grants
