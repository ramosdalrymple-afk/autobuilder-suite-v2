...
export const createProductionBuild = async (
  ...
  console.log("[createProductionBuild] Authorization context:", {
    type: context.authorization.type,
    userId: context.authorization.type === "user" ? context.authorization.userId : "N/A",
    projectId: props.projectId,
  });
  ...
  console.log("[createProductionBuild] canBuild result:", canBuild);
