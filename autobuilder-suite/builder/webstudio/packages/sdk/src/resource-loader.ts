...
// Strapi CMS resource URLs
export const strapiArticlesResourceUrl = `/rest/strapi/articles?populate=*`;
export const strapiProductsResourceUrl = `/rest/strapi/products?populate=*`;
export const strapiTeamMembersResourceUrl = `/rest/strapi/team-members?populate=*&sort=order:asc`;
export const strapiTestimonialsResourceUrl = `/rest/strapi/testimonials?populate=*`;
export const strapiFaqsResourceUrl = `/rest/strapi/faqs?sort=order:asc`;
export const strapiProjectsResourceUrl = `/rest/strapi/projects?populate=*`;
export const strapiServicesResourceUrl = `/rest/strapi/services?sort=order:asc`;
export const strapiTemplatesResourceUrl = `/rest/strapi/website-templates?populate=*&sort=order:asc`;
