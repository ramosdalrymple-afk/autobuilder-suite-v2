...
const env = {
  ...
  // Optional override to force a specific origin for OAuth callbacks (e.g. http://localhost:3000)
  ...
  // Local builder URL for static exports (when accessing via external URLs like wstd.dev)
  // This ensures static export downloads go to the local server where the files are generated
  // Set this to your actual local dashboard URL (with HTTPS if using SSL)
  LOCAL_BUILDER_URL: process.env.LOCAL_BUILDER_URL,
