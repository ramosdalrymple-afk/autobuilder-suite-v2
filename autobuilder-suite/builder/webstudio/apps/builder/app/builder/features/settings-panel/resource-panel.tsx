...
import {
  ...
  assetsResourceUrl,
  strapiArticlesResourceUrl,
  strapiProductsResourceUrl,
  strapiTeamMembersResourceUrl,
  strapiTestimonialsResourceUrl,
  strapiFaqsResourceUrl,
  strapiProjectsResourceUrl,
  strapiServicesResourceUrl,
  strapiTemplatesResourceUrl,
...
>(({ variable }, ref) => {
  ...
  const localResources = [
    ...
    // Strapi CMS Resources
    {
      label: "Strapi: Articles",
      value: JSON.stringify(strapiArticlesResourceUrl),
      description:
        "Fetch blog articles from Strapi CMS. Returns title, slug, excerpt, content, and featured image.",
      category: "strapi",
    },
    {
      label: "Strapi: Products",
      value: JSON.stringify(strapiProductsResourceUrl),
      description:
        "Fetch products from Strapi CMS. Returns name, slug, price, description, and images.",
      category: "strapi",
    },
    {
      label: "Strapi: Team Members",
      value: JSON.stringify(strapiTeamMembersResourceUrl),
      description:
        "Fetch team members from Strapi CMS. Returns name, role, bio, photo, and social links.",
      category: "strapi",
    },
    {
      label: "Strapi: Testimonials",
      value: JSON.stringify(strapiTestimonialsResourceUrl),
      description:
        "Fetch testimonials from Strapi CMS. Returns quote, author, company, and rating.",
      category: "strapi",
    },
    {
      label: "Strapi: FAQs",
      value: JSON.stringify(strapiFaqsResourceUrl),
      description:
        "Fetch FAQs from Strapi CMS. Returns question, answer, and category.",
      category: "strapi",
    },
    {
      label: "Strapi: Projects",
      value: JSON.stringify(strapiProjectsResourceUrl),
      description:
        "Fetch portfolio projects from Strapi CMS. Returns title, slug, description, client, and images.",
      category: "strapi",
    },
    {
      label: "Strapi: Services",
      value: JSON.stringify(strapiServicesResourceUrl),
      description:
        "Fetch services from Strapi CMS. Returns title, slug, description, features, and pricing.",
      category: "strapi",
    },
    {
      label: "Strapi: Templates",
      value: JSON.stringify(strapiTemplatesResourceUrl),
      description:
        "Fetch website templates from Strapi CMS. Returns name, category, Webstudio project ID, and thumbnail.",
      category: "strapi",
    },
  ];
