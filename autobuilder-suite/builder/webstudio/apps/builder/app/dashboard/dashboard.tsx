...
import { BodyIcon, ExtensionIcon, WebstudioIcon } from "@webstudio-is/icons";
  ...
  return (
    <TooltipProvider>
      <Flex css={{ height: "100vh" }}>
        ...
        {view === "templates" && <Templates templates={templates} />}
        {view === "welcome" && <Templates templates={templates} welcome />}
