...
import { initStaticExport } from "./static-export-init.server";
...
// Initialize static export handler for local development
// This is only needed when running without a remote deployment service
if (TRPC_SERVER_URL === "" || TRPC_SERVER_API_TOKEN === "") {
  initStaticExport();
}
