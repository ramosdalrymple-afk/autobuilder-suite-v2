...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceUnit: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'per project'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiWebsiteTemplateWebsiteTemplate
  extends Struct.CollectionTypeSchema {
  collectionName: 'website_templates';
  info: {
    description: 'Webstudio starter templates managed via CMS';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    webstudioProjectId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::website-template.website-template': ApiWebsiteTemplateWebsiteTemplate;
